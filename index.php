   ...
   <div class="col-lg-8">
    ...
    <div class="clearfix">
     <?php 
            ...
            $query = $link->query("SELECT * FROM posts ORDER BY created_at DESC LIMIT $offset, $num_per_page");
            ?>
     ...
     <div class="card mb-4">
      ...
      <div class="card-body">
       ...
       <a href="post_detail.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary">Read More</a>
      </div>
     </div>
     <?php endwhile; ?>
     <?php else: ?>
