      ...
      <div class="card-body">
       ...
       <table id="datatablesSimple">
        ...
        <tr>
            ...
            <td><img src="../actions/post_photo/<?= $row['file_name'] ?>" <?= $row['file_name'] ?> alt="" width="50px"></td>
            <td>
            <a href="post_edit_form.php?id=<?= $row['id'] ?>" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i></a>
            <a href="post_detail.php?id=<?= $row['id'] ?>" class="btn btn-outline-primary"><i class="fa-sharp fa-solid fa-eye"></i></a>
            <a href="../actions/post_delete.php?id=<?= $row['id'] ?>" class="btn btn-outline-danger"> <i class="fa-solid fa-trash"></i></a>
           </td>
        </tr>
          <?php endwhile; ?>
        </tbody>
