 ...
 <div class="container">
  <div class="row">
   ...
   <div class="col-lg-8">
    ...
    <div class="card mb-4">
     <a href="#!"><img class="card-img-top" src="actions/post_photo/7b53e322494f4f5ca1845c4317786e98.jpg?php echo $row['file_name']; ?>" alt="..." /></a>
     <div class="card-body">
     ...
     <ul class="pagination justify-content-center mb-4">
      ...
      <?php 
       ...
       ?>
         ...
         <li class="page_item">
          <a class="page_link" href="post_index.php?<?= $i; ?>"><?= $i; ?></a>
         </li>
        <?php endfor; ?>
      <li class="page-item">
